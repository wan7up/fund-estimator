...
SCOPES: dict[str, tuple[str, ...]] = {
    "orchestrator": (
        ...
        "fund_estimator/models/ai_chat.py",
        "fund_estimator/services/ai_chat.py",
        "fund_estimator/services/compare_ai.py",
        ...
        "fund_estimator/web/ai_chat.html",
        "fund_estimator/web/ai_chat.js",
        "fund_estimator/web/ai_chat.css",
        "scripts/check_session_scope.py",
        "scripts/run_linux.sh",
        "tests/test_api.py",
        "tests/test_ai_chat.py",
        "tests/test_compare_ai.py",
        "requirements.txt",
    ),
    "estimate": (
